...
// since the length is variable so use useState
// concept of useCallback in react is used here
// is is also hook like useState
// useRef is used to copy the password to clipboard
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <div className='flex text-sm gap-x-2'>
            ...
            <div className="flex items-center gap-x-1">
              ...
              <label 
              htmlFor="CharactersInput">Characters</label>
            </div>
        </div>
      </div>
  )
